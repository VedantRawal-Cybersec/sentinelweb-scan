  ...
  head: () => ({
    meta: [
      ...
      { title: "Sentinel AI — Real Security Assessments" },
      {
        name: "description",
        content:
          "Run real, AI-guided security assessments on any website. Headers, TLS, DNS, IP reputation and a remediation roadmap in seconds.",
      },
      { property: "og:title", content: "Sentinel AI — Real Security Assessments" },
      {
        property: "og:description",
        content: "AI-powered security posture analysis for any website.",
      },
